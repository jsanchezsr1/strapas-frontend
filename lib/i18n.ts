...
export function getHowItWorksCopy(language: Language) {
  return {
    title: pick(language, text('How it works', 'Comment ca marche', 'Como funciona', 'Come funziona', 'Como funciona')),
    description: pick(language, text('Start with a plain-English prompt, refine structure, preview generated screens, and publish to a production-ready front end.', 'Commencez par un prompt simple, affinez la structure, previsualisez les ecrans generes et publiez un front end pret pour la production.', 'Comece com um prompt simples, refine a estrutura, visualize telas geradas e publique um front-end pronto para producao.', 'Inizia con un prompt semplice, rifinisci la struttura, visualizza le schermate generate e pubblica un front end pronto per la produzione.', 'Empieza con un prompt simple, refina la estructura, previsualiza las pantallas generadas y publica un front end listo para produccion.')),
  };
}
    ...
    plans: [
      {
        ...
        highlights: [
          ...
          pick(language, text('25 bonus invite credits', '25 credits bonus d invitation', '25 creditos extras de convite', '25 crediti bonus di invito', '25 creditos extra de invitacion')),
