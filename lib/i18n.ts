...
export function getLoginCopy(language: Language) {
  return {
    ...
    loadingSession: pick(language, text('Checking your session...', 'Verification de votre session...', 'Verificando sua sessao...', 'Verifica della sessione in corso...', 'Comprobando tu sesion...')),
    signedInTitle: pick(language, text('You are signed in', 'Vous etes connecte', 'Voce esta conectado', 'Hai effettuato l accesso', 'Has iniciado sesion')),
    signedInDescription: pick(language, text('Your Google account is connected and ready to continue into Strapas.', 'Votre compte Google est connecte et pret pour continuer dans Strapas.', 'Sua conta Google esta conectada e pronta para continuar no Strapas.', 'Il tuo account Google e connesso e pronto per continuare in Strapas.', 'Tu cuenta de Google esta conectada y lista para continuar en Strapas.')),
    signedInAs: pick(language, text('Signed in as', 'Connecte en tant que', 'Conectado como', 'Accesso come', 'Sesion iniciada como')),
    continueAfterSignIn: pick(language, text('Continue to home', 'Continuer vers l accueil', 'Continuar para a pagina inicial', 'Continua alla home', 'Continuar al inicio')),
    signOut: pick(language, text('Sign out', 'Se deconnecter', 'Sair', 'Disconnetti', 'Cerrar sesion')),
